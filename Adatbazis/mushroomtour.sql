...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Ápr 04. 08:32
...
(4, 'Agaricus bernardii', 'Sziki csiperke', 'Csiperke', 0, NULL, 'Tavasz végétől ősz közepéig, legelőkön, boszorkány körben.', 0, 1, 6, 11, 'Szikes alföldi tájakon', 'Kalapos', 'Lemezes', 'Domború', 'Fénytelen', 'Sima', 'Sűrű', 'Sima', 'Gallér', 'Hengeres', 'Foszladozik', 'Vastag', 'Nincs', 'Nincs', 'Nem kellemes', 0, 'Nagy Angéla', 'Csiperke_sziki'),
(5, 'Agaricus bisporus ', 'Kétspórás csiperke', 'Csiperke', 0, NULL, 'Márciustól egészen novemberig. Kertekben, parkokban, komposzton.', 0, 1, 3, 11, 'Kertekben, parkokban, komposzton', 'Kalapos', 'Lemezes', 'Félgömb', 'Sima', 'Begöngyölt', 'Sűrű', 'Sima', 'Gallér', 'Hengeres', 'Sima', 'Kemény', 'Vörös', 'Kellemes', 'Kellemes', 0, 'Boros Lajos', 'Csiperke_ketsporas'),
...
(8, 'Agaricus crocodilinus', 'Nagyspórás csiperke', 'Csiperke', 0, NULL, 'Májustól novemberig nő legelőkön. Az állat tartás csökkenésével egyre ritkább.', 0, 1, 5, 11, 'Réten, erdőszélen, esetleg parkban', 'Kalapos', 'Lemezes', 'Félgömb', 'Pikkelyes', 'Sima', 'Sűrű', 'Sima', 'Gallér', 'Hengeres', 'Pelyhes', 'Vastag', 'Nincs', 'Nincs', 'Keserümandula', 0, 'Kőszegi Balázs', 'Csiperke_nagysporas'),
...
(13, 'Russula cyanoxantha', 'Kékhátú galambgomba', 'Galambgomba', 0, NULL, 'Nyár elejétől ősz közepéig lomb és fenyőerdőben termő együtt élő faj. Nevével ellentétben kalapja sohasem kék , húsa pattanva tőrik  ', 0, 0, 6, 10, 'Lomb- és fenyőerdőben', 'Kalapos', 'Lemezes', 'Félgömb', 'Nedves', 'Sima', 'Sűrű', 'Sima', 'Nincs', 'Hengeres', 'Sima', 'Pattanva törik', 'Nincs', 'Mogyoró', 'Nincs', 0, 'Hajda Piroska', 'Galambgomba_kekhatu'),
...
(16, 'Russula heterophylla', 'Dióízű galambgomba', 'Galambgomba', 0, NULL, 'Májustól novemberig, Bőre n mindig éri el a kalap szélet .Nevét az ízéről kapta.', 0, 0, 6, 11, 'Lomberdőkben', 'Kalapos', 'Lemezes', 'Félgömb', 'Kissé ragadós', 'A bőre nem éri el', 'Sűrű', 'Sima', 'Nincs', 'Hengeres', 'Ráncosodó', 'Pattanva törik', 'Nincs', 'Dió', 'Nincs', 0, 'Nagy Angéla', 'Galambgomba_dioizu'),
...
(21, 'Amanita excelsa ', 'Szürke galóca', 'Galóca', 0, 'Feltételesen ehető', 'Nyár elejitől ősz végéig savanyú talajú lomberdőben, nem gyakori gomba. Pettyek könnyen leválhatnak 20 perc főzés időt igényel .', 0, 1, 6, 11, 'Lomberdőkben', 'Kalapos', 'Lemezes', 'Domború', 'Pettyes', 'Sima', 'Sűrű', 'Sima', 'Gallér', 'Hengeres', 'Kígyóbőr', 'Fehér', 'Nincs', 'Nincs', 'Nincs', 0, 'Molnár Rudolf', 'Galoca_szurke'),
...
(32, 'Verpa conica', 'Simasüvegű kucsmagomba', 'Kucsmagomba', 0, 'Feltételesen ehető', 'Áprilistól májusig, ligeterdőben, folyópartokon gyűjthető faj.', 0, 0, 4, 5, 'Lomb- és fenyőerdőben', 'Kucsma alaku süveg', 'Méh sejt', 'Süveg', 'Gyűszű', 'Nincs', ' Finoman ráncolt', 'Nincs', 'Nincs', 'Üreges', 'Szemcsés', 'Vattás', 'Nincs', 'Nincs', 'Nincs', 0, 'Frits Kata', 'Kucsmagomba_simasuvegu'),
...
(44, 'Lycoperdon excipuliforme', 'Változékony pöfeteg', 'Pöfeteg', 0, 'Fiatalon ehető', 'Júniustól novemberig. fehér, majd krémszínű, barnuló termőteste hosszúkás. Csak fiatalon fogyasztható.', 0, 0, 7, 11, 'Erdő,rétek,legelők', 'Pöfeteg', 'Zárt ternőtest', 'Körte forma', 'Pikkelyes', 'Nincs', 'Nincs', 'Nincs', 'Nincs', 'Egybenött', 'Pikkelyes', 'Kemény', 'Nincs', 'Nincs', 'Nincs', 0, 'Szűcs Béla', 'Pofeteg_valtozekony'),
(45, 'Lycoperdon utriforme', 'Pikkelyes pöfeteg', 'Pöfeteg', 0, 'Fiatalon ehető', 'Júniustól az ősz végi fagyokig. Termőtest felszíne  pikkelyes. Addig ehető , míg fiatal és fehér a belseje. Íze markánsabb mint más pöfetegé.', 0, 0, 6, 11, 'Rétek,legelők,tisztások', 'Pöfeteg', 'Zárt ternőtest', 'Zsák alaku', 'Pikkelyes', 'Nincs', 'Nincs', 'Nincs', 'Nincs', 'Rövid egybenött', 'Pikkelyes', 'Szivacsos', 'Nincs', 'Nincs', 'Nincs', 0, 'Varju Sándor', 'Pofeteg_pikkelyes'),
...
(65, 'Suillus bovinus', 'Tehéntinóru', 'Tinóru', 0, 'Feltételesen ehető', 'Nyár végi, őszi savanyú talajú kéttűs fenyvesekben nő, gyorsan kukacosodon  étkezésében nem értékes gomba.', 0, 0, 8, 11, 'Savanyú talajú erdei fenyvesekben', 'Kalapos', 'Csöves', 'Félgömb', 'Okkerbarna', 'Peremig nem érő', 'Nincs', 'Nincs', 'Nincs', 'Hengeres', 'Csupasz', 'Gumiszerű', 'Nincs', 'Savanykás', 'Gyümölcsös', 0, 'Molnár Rudolf', 'Tinoru_tehen'),
(66, 'Caloboletus calopus', 'Farkastinóru', 'Tinóru', 1, 'Mérgező', 'Nyár  közepétől ősz közepéig .Savanyú talajú erdőben. Szak irodalom szerint írtka faj de környékünkön meg található. Mérgező faj.\r\n', 0, 0, 7, 11, 'Savanyú talajú lombos és fenyőerdőben', 'Kalapos', 'Csöves', 'Félgömb', 'Sima', 'Aláhajló', 'Nincs', 'Nincs', 'Nincs', 'Hengeres', 'Erősen vörös, hálózatos tönk', 'Merev, sárga vagy fehéres', 'Enyhén kékül', 'Nincs', 'Nincs', 0, 'Molnár Storman Ákos', 'Tinoru_farkas'),
(67, 'Chalciporus piperatus', 'Borsos tinóru', 'Tinóru', 0, NULL, 'Nyár közepétől ősz végéig .Savanyú talajú lombos és fenyőerdőben. Legújabb kutattasó kalapján galóca parazita.', 0, 0, 7, 11, 'Savanyú talajú lombos és fenyőerdőben', 'Kalapos', 'Csöves', 'Domború', 'Tapadós', 'Peremig nem érő', 'Nincs', 'Nincs', 'Nincs', 'Hengeres', 'Szemcsés', 'Vastag', 'Kékül', 'Savanykás', 'Mogyoró', 0, 'Molnár Rudolf', 'Tinoru_borsos'),
(68, 'Imleria badia', 'Barna tinóru', 'Tinóru', 0, NULL, 'Nyár második felében ősszel terem. Decemberben fagyott példányokkal is találkozhatunk , savanyú talajú lomb- és fenyőerdőket kedveli.', 0, 0, 7, 11, 'Lomb- és fenyőerdőben', 'Kalapos', 'Csöves', 'Félgömb', 'Tapadós', 'Peremig nem érő', 'Nincs', 'Nincs', 'Nincs', 'Hengeres', 'Hanvas', 'Kemény', 'Kékül', 'Nincs', 'Gyümölcsös', 0, 'Szegedi Zsolt', 'Tinoru_barna'),
...
(85, 'Suillus granulatus', 'Szemcsésnyelű fenyőtinóru', 'Tinóru_Fenyő', 0, NULL, 'Kora nyártól késő őszig, kéttűs fenyő alatt terem. El készítés előtt húzzuk le a kalap bőrt de lehet, hogy barna lesz a kezünk amit nehéz lesz lemosni.', 0, 0, 6, 11, 'Kéttűs fenyő (erdei és feketefenyő)', 'Kalapos', 'Csöves', 'Félgömb', 'Sárga', 'Peremig nem érő', 'Nincs', 'Nincs', 'Nincs', 'Hengeres', 'Pontozót nyálkás', 'Vastag', 'Nincs', 'Savanykás', 'Nincs', 0, 'Kőszeginé Tóth Judit', 'Fenyőtinoru_szemcsesnyelu'),
...
(93, 'Boletus aereus ', 'Bronzos vargánya', 'Vargánya', 0, NULL, 'Nyári és kora őszi hónapok, tölgyesekben találkozhatunk vele. Egyes helyeken Feketehátú tinórunak is nevezik .Intenzív vargánya illat jól szárítható.', 0, 0, 6, 9, 'Hegyvidéki lucosokban, néha savanyú talajú bükkösökben nő', 'Kalapos', 'Csöves', 'Félgömb', 'Molyhos', 'Nem éri el', 'Nincs', 'Nincs', 'Nincs', 'Vastag hengeres', 'Sűrű hálózat', 'Kemény', 'Nincs', 'Nincs', 'Vargánya', 0, 'Vidra Gyula', 'Varganya_bronzos'),
(94, 'Boletus edulis', 'Ízletes vargánya', 'Vargánya', 0, NULL, 'Kora nyáron és ősszel két hullámban főleg tölgy, bükk és lucfenyő alján terem. Gyulladás csökkentő hatását kevesen ismerik .Keresett gomba tinóuként is gyűjtik ', 0, 0, 6, 11, 'Lomberdőkben,  tölgy és bükkmikorrhizás', 'Kalapos', 'Csöves', 'Félgömb', 'Foltos', 'Nem éri el', 'Nincs', 'Nincs', 'Nincs', 'Vastag hengeres', 'Hálózatos', 'Kemény', 'Nincs', 'Nincs', 'Nincs', 0, 'Nagy Angéla', 'Varganya_izletes'),
