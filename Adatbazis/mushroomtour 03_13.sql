...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Már 13. 10:22
...
(25, 'Amanita caesarea', 'Császárgalóca', 'Galóca', 3, 'Védett', 'Teljesen narancs sárga gomba gyűjtését a törvény bünteti', 1, 1, 6, 10, 'Savanyú talajú lomberdőben', 'Kalapos', 'Lemezes', 'Félgömb', 'Fénylő', 'Bordázott', 'Sűrű', 'Finoman csipkézet', 'Gallér', 'Hengeres', 'Sima', 'Puha', 'Nincs', 'Nincs', 'Nincs', 5000, 'Boros Lajos', 'Galoca_csaszar'),
...
(47, 'Langermannia gigantea', 'Óriás pöfeteg', 'Pöfeteg', 0, 'Fiatalon ehető', 'Többé kevésbé gömbölyű, nagytermetű talajlakó gombafaj, fél méteres étmérőjűre és 10 kg-osra is megnőhet', 0, 0, 6, 10, 'Erdő,mező', 'Pöfeteg', 'Zárt ternőtest', 'Gömbölyű', 'Ráncos', 'Nincs', 'Nincs', 'Nincs', 'Nincs', 'Egybenött', 'Ráncosodó', 'Rugalmas', 'Nincs', 'Nincs', 'Nincs', 0, 'Szajkó Attila', 'Pofeteg_orias'),
(48, 'Bovista plumbea', 'Szürke pöfeteg', 'Pöfeteg', 0, 'Fiatalon ehető', 'Fehér felületesima kissé táblásan felrepedező, felső burok tojáshéj szerűen leválik.', 0, 0, 3, 8, 'Legelök', 'Pöfeteg', 'Zárt ternőtest', 'Golyó', 'Sima', 'Nincs', 'Nincs', 'Nincs', 'Nincs', 'Egybenött', 'Sima', 'Szivacsos', 'Nincs', 'Nincs', 'Nincs', 0, 'Nagy Angéla', 'Pofeteg_szurke'),
...
(58, 'Clathrus archeri', 'Tintahalgomba', 'Szömörcsög', 2, 'Nem ehető', 'A termőtest 4-7 darab vörös színű szivacsos szerkezetü tintahalszerű kar .', 1, 0, 6, 10, 'Lomberdőben megtalálható', 'Csáp', 'Karok belsö oldala', 'Csápok', 'Nyálkás', 'Nyálkás', 'Nincs', 'Nincs', 'Nincs', 'Egybenött', 'Szivacsos', 'Szivacsos', 'Nincs', 'Nincs', 'Dögszag', 0, 'Kőszeginé Tóth Judit', 'Tintahalgomba'),
...
(73, 'Suillellus mendax', 'Csalóka tinoru', 'Tinóru', 0, 'Feltételesen ehető', 'Csalóka a színe  Száraz időben barnássárga nedves időben bíbor', 0, 0, 6, 8, 'Savanyú talajú bükk,gesztenye.csertölgy', 'Kalapos', 'Csöves', 'Félgömb', 'Sima', 'Peremig nem érő', 'Nincs', 'Nincs', 'Nincs', 'Vastag', 'Hálozatos', 'Kemény', 'Kékül', 'Nincs', 'Nincs', 0, 'Molnár Rudolf', 'Tinoru_csaploka'),
...
(89, 'Gyroporus castaneus', 'Gesztenyebarna üregestinóru', 'Tinóru_Üreges', 0, NULL, 'Melegkedvelő lombos és fenyőerdőben, savanyú preferenciával, az alföldtől az alacsonyabb hegyvidékig, nyártól koraőszig.', 0, 0, 6, 10, 'Lomberdoben tölgy, bükk,gyertyán ', 'Kalapos', 'Csöves', 'Ellaposodót', 'Bársonyos', 'Peremig nem érő', 'Nincs', 'Nincs', 'Nincs', 'Hengeres', 'Üreges', 'Törékeny', 'Nincs', 'Nincs', 'Mogyoró', 0, 'Dr.Dima Bálint', 'Uregestinoru_gesztenyebarna'),
(90, 'Coprinellus micaceus ', 'Kerti tintagomba', 'Tintagomba', 0, 'Feltételesen ehető', 'Júliustól novemberig lomb- és fenyőerdőben, ligetes, füves helyen növő helyenként nem ritka faj.', 0, 0, 7, 11, 'Lomb- és fenyőerdőben, ligetes, füves helyen', 'Kalapos', 'Lemezes', 'Kúpos', 'Szemcsés', 'Tönköt éri', 'Sűrű', 'Sima', 'Nincs', 'Vékony', 'Csupasz', 'Fehér', 'Nincs', 'Nincs', 'Kellemes', 0, 'Dr.Csajbók József', 'Tintagomba_kerti'),
