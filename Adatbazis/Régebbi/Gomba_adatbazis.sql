...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Okt 16. 10:01
...
CREATE TABLE `gomba` (
  `ID` int(11) NOT NULL,
  `Latin_nev` varchar(27) CHARACTER SET utf8 DEFAULT NULL,
  `Magyar_nev` varchar(25) CHARACTER SET utf8 DEFAULT NULL,
  `Nemzetseg` varchar(13) CHARACTER SET utf8 DEFAULT NULL,
  `Etkezes_ertek` int(1) DEFAULT NULL,
  `Feltetel` varchar(21) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `Kalap_perem` varchar(17) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `Kep_keszeto_neve` varchar(50) COLLATE utf8mb4_hungarian_ci NOT NULL
...
INSERT INTO `tervezet_turak` (`Id`, `Letrehozo`, `Indulas_ido`, `Indulas_hely`, `Varhato_erkezési_ido`, `Erkezesi_hely`, `Utvolan_nehezsege`, `Szervezo_elerhetosege`, `Tura_dija`) VALUES
(1, 'Szerkesztőség', '2023-10-01 08:00:00', 'Rudabányácska Smaragdvölgy', '2023-10-01 12:00:00', 'Rudabányácska Smaragdvölgy', 'Könnyű/Közepes/Nehéz', 'Email/ telefon', '2000 HUF');
