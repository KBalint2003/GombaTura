...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Okt 05. 08:05
...
CREATE TABLE `zemplen_eheto_gombai_teljes` (
  ...
  `Ethezes_erteke` int(1) DEFAULT NULL,
  `Besorolas` varchar(18) CHARACTER SET utf8 COLLATE utf8_hungarian_ci DEFAULT NULL,
  ...
  `Termoretegtart_tipusok` varchar(8) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `Lemezel` varchar(13) CHARACTER SET utf8 COLLATE utf8_hungarian_ci DEFAULT NULL,
...
INSERT INTO `zemplen_eheto_gombai_teljes` (`ID`, `Latin_nev`, `Magyar_nev`, `Nemzetseg`, `Ethezes_erteke`, `Besorolas`, `Leiras`, `Szezon_eleje`, `Szezon_vege`, `Novenyzet`, `Termotest_tipus`, `Termoretegtart_tipusok`, `Bocskora`, `Galler`, `Burok_maradvany`, `Kalap_forma`, `Kalap_felszin`, `Kalap_perem`, `Lemezallas`, `Lemezel`, `Tonk_alak`, `Tonk_felulet`, `Hus`, `Hus_elszinezodes`) VALUES
...
(43, 'Amanita muscaria', 'Légyölő galóca', 'Galóca', 1, 'Mérgező', 'Augusztustól novemberig, erősen savanyú talajú lomb- és fenyőerdőben növő, helyenként gyakori faj.', 8, 11, 'Lomb- és fenyőerdőben', 'Kalapos', 'Lemezes', 0, 1, 'Gallér', 'Félgömb', 'Könnyen leváló, fehér pettyek', 'Sima', 'Sűrű', 'Sima', 'Vastag, hengeres', 'Sima', 'Puha, vizenyős', 'Nincs'),
(44, 'Amanita phalloides', 'Gyilkos galóca', 'Galóca', 1, 'Mérgező\n', 'Júniustól novemberig, lomberdőben, főleg tölgy alatt, ritkán fenyvesben növő, gyakori faj.', 6, 11, 'Lomberdőben tölgyes', 'Kalapos', 'Lemezes', 1, 1, 'Gallér', 'Félgömb', 'Sima', 'Sima', 'Sűrű', 'Sima', 'Hengeres', 'Kígyóbőr', 'Fehér vizenyős', 'Nincs'),
...
(69, 'Caloboletus calopus', 'Farkastinóru', 'Tinóru', 1, 'Mérgező', 'Savanyú talajú lombos és fenyőerdőben, nyártól őszig terem, dombvidéktől a magas hegységekig.', 6, 11, 'Savanyú talajú lombos és fenyőerdőben', 'Kalapos', 'Csöves', 0, 0, 'Nincs', 'Félgömb', 'Sima', 'Aláhajló', 'Nincs', 'Nincs', 'Hengeres', 'Erősen vörös, hálózatos tönk', 'Merev, sárga vagy fehéres', ' Enyhén kékül'),
